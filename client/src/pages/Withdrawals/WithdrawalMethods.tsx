...
import WithdrawalMethodTable from '../../components/WithdrawalTable/WithdrawalMethodTable'
        ...
        <>
            <div className='py-10 px-10'>
                ...
                <div className='flex flex-row justify-between'>
                    <h1 className='text-2xl font-semibold'>Withdrawals Methods</h1>
                    <div className='flex flex-row gap-4'>
                        ...
                        <Button className='bg-transparent border-primary border text-primary hover:bg-primary hover:text-white dark:text-dark dark:border-dark dark:hover:bg-dark dark:hover:text-white '>Add New</Button>
                    </div>
                </div>
